...
## define the latest chrome version for an accurate user-agent spoof
## The latest version is read from cURL and made a variable for qutebrowser to update every startup
# subprocess.run("curl", "")
...
## Type: FormatString
# WIP: c.content.headers.user_agent = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/{webkit_version} (KHTML, like Gecko) Chrome/{latest-chrome-version} Safari/{webkit_version}'
